    ...
    <div className="min-h-screen min-h-dvh flex flex-col items-center p-4 animate-slide-up">
      <div className="w-full max-w-md py-4">
        ...
        <div className="text-center mt-6">
          <p className="text-[11px] text-gray-300">Gomoku Online · EdgeOne Makers</p>
          <a
            href="https://github.com/xbail/gomoku-game"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1 mt-1.5 text-[11px] text-gray-400 hover:text-indigo-500 transition"
          >
